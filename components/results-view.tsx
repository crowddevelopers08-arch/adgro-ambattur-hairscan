...
import { REPORT_STORAGE_KEY } from "./report-page"
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "32px 16px 80px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ flexBasis: "100%", color: "#6b6b6b", fontSize: "0.82rem", lineHeight: 1.6 }}>
            <p style={{ fontWeight: 700, color: "#1a1a1a", marginBottom: "3px" }}>Adgro Hair Ambattur</p>
        ...
        >
          ...
          {submitting ? (
            ...
            <form onSubmit={handleDetailsSubmit} className="mt-2 flex flex-col gap-4 px-1 pb-2">
              ...
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="report-location" style={{ fontWeight: 600, fontSize: "0.85rem", color: "#1a1a1a" }}>Area</Label>
                <Input
                  id="report-location"
              ...
              <button
                type="submit"
                disabled={!detailsForm.name.trim() || !detailsForm.phone.trim() || !detailsForm.email.trim() || !detailsForm.location}
                style={{
                  ...
                  opacity: (!detailsForm.name.trim() || !detailsForm.phone.trim() || !detailsForm.email.trim() || !detailsForm.location) ? 0.5 : 1,
                  transition: "all 0.2s",
                  fontFamily: "inherit",
                }}
              >
